...
struct fitnessWidgetProvider: TimelineProvider {
    ...
    func getTimeline(in context: Context, completion: @escaping (Timeline<fitnessWidgetEntry>) -> Void) {
        healthManager.getSumData(for: HKQuantityType(.basalEnergyBurned), with: HKUnit.kilocalorie()
        ) { energy in
...
struct fitnessWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        StaticConfiguration(kind: kind, provider: fitnessWidgetProvider()) { entry in
